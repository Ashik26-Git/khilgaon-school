...
const MainSection = () => {
    return (
        <div className="relative">
            ...
            <div className="absolute top-1/2 left-1/2 space-y-10">
                <h1 className="text-[#F4F4F4] text-5xl  font-normal text-center">খিলগাঁও সরকারি উচ্চ বিদ্যালয়</h1>
                <button className="btn btn-primary text-white w-1/5 h-2/5">আরও জানুন</button>
            </div>
        </div>
    );
};
